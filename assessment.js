...
// CODE HERE
let myFriends = ["Nick", "Chris", "Scott", "John"];

// #6 Add a fifth friends name to the end of your myFriends array

// CODE HERE
myFriends[4] = "Harrison";
...
function evensOnly() {
  // CODE HERE
  return myNumbers.filter(x => x % 2 === 0);
}
...
let trueFriends = peopleIknow.filter(x => x.friend === true);
